...
export declare function Track({ filled, size, color, classNames, styles, radius, children, offset, onMouseLeave, onMouseEnter, disabled, ...others }: TrackProps): JSX.Element;
